...
@section('content')
<div class="mb-2">
    <a class="btn btn-success" href="{{ route('admin.wallets.user.pdf') }}" target="_blank">Download All Balances (PDF)</a>
</div>
    <div class="table-responsive">
        <x-data-table title="Users" table-id="users-table" fetch-url="{{ route('admin.wallets.users.data') }}"
